...
# from camillia.modules.sql import warns_sql as warnssql
import camillia.modules.sql.blacklist_sql as blacklistsql

# from camillia.modules.sql import cust_filters_sql as filtersql
# import camillia.modules.sql.welcome_sql as welcsql
import camillia.modules.sql.locks_sql as locksql
import camillia.modules.sql.notes_sql as sql

# from camillia.modules.rules import get_rules
import camillia.modules.sql.rules_sql as rulessql
from camillia import EVENT_LOGS, LOGGER, OWNER_ID, SUPPORT_CHAT, dispatcher
from camillia.__main__ import DATA_IMPORT
from camillia.modules.connection import connected
from camillia.modules.helper_funcs.alternate import typing_action
from camillia.modules.helper_funcs.chat_status import user_admin
from camillia.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("camillia{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("camillia{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `camillia-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("camillia{}.backup".format(chat_id))  # Cleaning file
