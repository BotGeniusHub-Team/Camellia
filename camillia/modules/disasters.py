...
ELEVATED_USERS_FILE = os.path.join(os.getcwd(), "camillia/elevated_users.json")
...
*Global Blue Text*
 ❍ /gignoreblue*:* <word>*:* Globally ignore bluetext cleaning of saved word across Ishikki's Robot.
